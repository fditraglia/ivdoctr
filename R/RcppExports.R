...
classicalSampler <- function(Rho_vech, L, n_M, K_L = 0.2, K_U = 1, Rxsu_L = -0.9, Rxsu_U = 0.9, Rzu_L = -0.9, Rzu_U = 0.9) {
    .Call('ivdoctr_classicalSampler', PACKAGE = 'ivdoctr', Rho_vech, L, n_M, K_L, K_U, Rxsu_L, Rxsu_U, Rzu_L, Rzu_U)
}
