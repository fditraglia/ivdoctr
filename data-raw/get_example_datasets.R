...
download.file("http://economics.mit.edu/files/5136", "./data-raw/colonial.zip")
unzip("./data-raw/colonial.zip", files = "maketable4.dta", exdir = "./data-raw")
...
system("rm ./data-raw/maketable4.dta")

# Was Weber Wrong Example ===========================================
download.file("https://www.cesifo-group.de/dms/ifodoc/iPEHD/Datasets/ipehd_qje2009_data_tables.zip", "./data-raw/weber.zip", method = "curl") # need curl since https
...
system("rm ./data-raw/ipehd_qje2009_master.dta")
...
unzip("./data-raw/wooldridge.zip", files = c("WAGE2.raw", "WAGE2.DES"), 
      exdir = "./data-raw")
...
system("rm ./data-raw/WAGE2.DES")
system("rm ./data-raw/WAGE2.raw")
